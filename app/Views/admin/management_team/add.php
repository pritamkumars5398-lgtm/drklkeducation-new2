    ...
    <div class="container-fluid">
        <div class="card shadow-sm" style="border-radius: 8px;">
            <div class="card-header bg-white" style="border-bottom: 2px solid #f4f4f4; padding: 20px;">
                <h4 class="mb-0" style="color: #333; font-weight: 600;">Add Management Team Member</h4>
            </div>
            <div class="card-body" style="padding: 30px;">
                <form action="<?= base_url('admin/managementteam/save') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="designation" class="form-control p-2" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label" style="font-weight: 500;">Department</label>
                            <input type="text" name="department" class="form-control p-2">
                        </div>
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="description" class="form-control p-2" rows="4"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" name="sort_order" class="form-control p-2" value="0">
                        </div>
                        <div class="col-md-4 mb-3">
